...
CREATE DATABASE VPD_311_SQL_AllInOne
ON 
(
	NAME		= VPD_311_SQL,
	FILENAME	= 'D:\SQL2022\SQL22\MSSQL16.MSSQLSERVER\MSSQL\DATA\VPD_311_sql_AllInOne.mdf',
	SIZE		= 8MB,
	MAXSIZE		= 500MB,
	FILEGROWTH	= 8MB
)
...
(
	...
	FILENAME	= 'D:\SQL2022\SQL22\MSSQL16.MSSQLSERVER\MSSQL\DATA\VPD_311_SQL_log_AllInOne.ldf',
	SIZE		= 8MB,
	MAXSIZE		= 500MB,
	FILEGROWTH	= 8MB
)
...
CREATE TABLE RequiaredDisciplines
(
	discipline				SMALLINT,
...
(
	...
	discipline	SMALLINT		NOT NULL CONSTRAINT FK_Shedule_Disciplines	FOREIGN KEY REFERENCES Disciplines(discipline_id),
	teacher		INT				NOT NULL CONSTRAINT FFK_Shedule_Teachers	FOREIGN KEY REFERENCES Teachers(teacher_id),
